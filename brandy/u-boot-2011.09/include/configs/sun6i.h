...
#define LINUX_MACHINE_ID        3892

#define UBOOT_VERSION			"1.1.0"
#define UBOOT_PLATFORM		    "1.0.0"

#define CONFIG_TARGET_NAME      sun6i
/*
...
#define CONFIG_SYS_INIT_RAM_SIZE	     0x00048000
